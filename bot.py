...
DEFAULT_WELCOME = (
    "Здравствуйте!\n"
    "ВЯ — виртуальный консультант, созданный на основе классических подходов сексологии. Здесь вы сможете спокойно и анонимно обсудить любые вопросы, связанные с интимной сферой, отношениями или сексуальным здоровьем. Всё, что вы напишете, остаётся между нами.\n\n"
